...
2.2. **Datos de uso:** Historial de búsqueda, vehículos guardados, parámetros de filtrado

## 3. FINALIDADES DEL TRATAMIENTO
3.1. **Principal:** Permitir buscar, comparar y guardar vehículos del mercado chileno.
3.2. **Secundarias:** Envío de información sobre ofertas, mejora del servicio.
...
Usted tiene derecho a acceder, rectificar, eliminar, oponerse, portabilidad y revocar el consentimiento.

## 6. CONSERVACIÓN DE DATOS
- Datos de cuenta: Mientras la cuenta esté activa
- Historial: 2 años desde la última actividad

## 7. CESIÓN DE DATOS
No se ceden datos a terceros salvo por requerimiento judicial.
...
1.1. Es mayor de 18 años o cuenta con autorización de su representante legal.
1.2. Los datos proporcionados son veraces y actualizados.
...
- Mantener confidencialidad de su cuenta
- No utilizar el servicio para fines fraudulentos
- Reportar uso no autorizado

## 4. RESPONSABILIDADES DEL PROVEEDOR
- Mantener disponibilidad del servicio (99% uptime)
- Proteger datos conforme a Ley 21.719
- NO se responsabiliza por decisiones de compra o discrepancias de precios
